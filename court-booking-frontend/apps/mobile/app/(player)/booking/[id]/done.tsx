        ...
        <View className="w-full bg-white rounded-[20px] p-5.5 gap-4.5">
          ...
          <View className="flex-row">
            ...
            <View className="flex-1 gap-0.5">
              ...
              <Text className="font-mono-semibold text-[15px] text-player-ink">{formatPKR(booking.amount_paid)}</Text>
            </View>
            <View className="flex-1 gap-0.5">
              <Text className="font-figtree-bold text-[10.5px] tracking-[0.1em] text-player-ink-fainter">AT VENUE</Text>
              <Text className="font-mono-semibold text-[15px]" style={{ color: "#B5730B" }}>
