...
/**
 * A one-second countdown (QA #5): call `start(n)` with seconds; `seconds` ticks down to 0.
 * Used for the lockout `retry_after_seconds` and the OTP expiry countdowns on the auth screens.
 */
